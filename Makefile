...
OBJS = $O/src/ClusterTree/IEEE802154_CT_APP.o $O/src/ClusterTree/IEEE802154_CT_MAC.o $O/src/ClusterTree/IEEE802154_CT_NET.o $O/src/ClusterTree/IEEE802154_CT_PHY.o $O/src/NetCod/MAC_CT_NC.o
...
clean:
	...
	-rm -f src/NetCod/*_m.cc src/NetCod/*_m.h

cleanall: clean
	-rm -rf $(PROJECT_OUTPUT_DIR)

depend:
	$(MAKEDEPEND) $(INCLUDE_PATH) -f Makefile -P\$$O/ -- $(MSG_CC_FILES)  ./*.cc simulations/*.cc simulations/CT/*.cc simulations/CT/results/*.cc simulations/ClusterTree/*.cc simulations/ClusterTree/results/*.cc src/*.cc src/ClusterTree/*.cc src/NetCod/*.cc
...
$O/src/ClusterTree/IEEE802154_CT_PHY.o: src/ClusterTree/IEEE802154_CT_PHY.cc \
	...
	$(INETMANET_2_0_PROJ)/src/wpan/linklayer/ieee802154/contract/Ieee802154Enum.h \
	$(INETMANET_2_0_PROJ)/src/wpan/linklayer/ieee802154/contract/Ieee802154MacPhyPrimitives_m.h
$O/src/NetCod/MAC_CT_NC.o: src/NetCod/MAC_CT_NC.cc \
	src/NetCod/MAC_CT_NC.h \
	$(INETMANET_2_0_PROJ)/src/base/BasicModule.h \
	$(INETMANET_2_0_PROJ)/src/base/Coord.h \
	$(INETMANET_2_0_PROJ)/src/base/INETDefs.h \
	$(INETMANET_2_0_PROJ)/src/base/INotifiable.h \
