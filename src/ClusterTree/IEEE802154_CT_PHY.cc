...
#include "IEEE802154_CT_PHY.h"

Define_Module(IEEE802154_CT_PHY);
...
simsignal_t IEEE802154_CT_PHY::bitrateSignal = SIMSIGNAL_NULL;
simsignal_t IEEE802154_CT_PHY::radioStateSignal = SIMSIGNAL_NULL;
simsignal_t IEEE802154_CT_PHY::channelNumberSignal = SIMSIGNAL_NULL;
simsignal_t IEEE802154_CT_PHY::lossRateSignal = SIMSIGNAL_NULL;

uint16_t IEEE802154_CT_PHY::aMaxPHYPacketSize  = 127;      //max PSDU size (in bytes) the PHY shall be able to receive
uint16_t IEEE802154_CT_PHY::aTurnaroundTime    = 12;       //Rx-to-Tx or Tx-to-Rx max turnaround time (in symbol period)
uint16_t IEEE802154_CT_PHY::aMaxBeaconOverhead             = 75;       //max # of octets added by the MAC sublayer to the payload of its beacon frame
uint16_t IEEE802154_CT_PHY::aMaxBeaconPayloadLength = aMaxPHYPacketSize - aMaxBeaconOverhead;       //max size, in octets, of a beacon payload
uint16_t IEEE802154_CT_PHY::aMaxFrameOverhead              = 25;       //max # of octets added by the MAC sublayer to its payload w/o security.//max # of octets that can be transmitted in the MAC frame payload field
uint16_t IEEE802154_CT_PHY::aMaxMACFrameSize  = aMaxPHYPacketSize - aMaxFrameOverhead;


IEEE802154_CT_PHY::IEEE802154_CT_PHY() : rs(this->getId())
{
    radioModel = NULL;
    receptionModel = NULL;
    CCA_timer = NULL;
...
void IEEE802154_CT_PHY::registerBattery()
{
...
IEEE802154_CT_PHY::~IEEE802154_CT_PHY()
{
...
void IEEE802154_CT_PHY::initialize(int stage)
{
    ChannelAccess::initialize(stage);

    EV << getParentModule()->getParentModule()->getFullName() << ": initializing IEEE802154_CT_PHY, stage=" << stage << endl;
...
void IEEE802154_CT_PHY::finish()
{
}

bool IEEE802154_CT_PHY::processAirFrame(AirFrame *airframe)
{
...
void IEEE802154_CT_PHY::handleMessage(cMessage *msg)
{
    // handle primitives
...
void IEEE802154_CT_PHY::handlePrimitive(int msgkind, cMessage *msg)
{
...
AirFrame* IEEE802154_CT_PHY::encapsulatePacket(cMessage *frame)
{
...
void IEEE802154_CT_PHY::handleUpperMsg(AirFrame *airframe)
{
...
void IEEE802154_CT_PHY::sendUp(cMessage *msg)
{
    if (receiverConnect)
    {
...
void IEEE802154_CT_PHY::sendDown(AirFrame *airframe)
{
    sendToChannel(airframe);
}

void IEEE802154_CT_PHY::bufferMsg(AirFrame *airframe) //FIXME: add explicit simtime_t atTime arg?
{
...
AirFrame* IEEE802154_CT_PHY::unbufferMsg(cMessage *msg)
{
...
void IEEE802154_CT_PHY::handleLowerMsgStart(AirFrame * airframe)
{
...
void IEEE802154_CT_PHY::handleLowerMsgEnd(AirFrame * airframe)
{
    ...
    if (snrInfo.ptr == airframe)
    {
        ...
        {
            EV << "[PHY]: reception of r/ieee802154/IEEE802154_CT_PHY.cc line 432." << airframe->getName() << " frame failed because MAC layer turned off the receiver forcibly during the reception, drop it \n";
...
void IEEE802154_CT_PHY::handleSelfMsg(cMessage *msg)
{
    switch (msg->getKind())
    {
...
void IEEE802154_CT_PHY::PD_DATA_confirm(PHYenum status)
{
...
void IEEE802154_CT_PHY::PD_DATA_confirm(PHYenum status,short additional)
{
    Ieee802154MacPhyPrimitives *primitive = new Ieee802154MacPhyPrimitives();
    primitive->setKind(PD_DATA_CONFIRM);
    primitive->setStatus(status);
...
void IEEE802154_CT_PHY::PLME_CCA_confirm(PHYenum status)
{
    Ieee802154MacPhyPrimitives *primitive = new Ieee802154MacPhyPrimitives();
...
void IEEE802154_CT_PHY::PLME_bitRate(double bitRate)
{
    Ieee802154MacPhyPrimitives *primitive = new Ieee802154MacPhyPrimitives();
...
void IEEE802154_CT_PHY::PLME_ED_confirm(PHYenum status, uint16_t energyLevel)
{
    Ieee802154MacPhyPrimitives *primitive = new Ieee802154MacPhyPrimitives();
...
void IEEE802154_CT_PHY::PLME_SET_TRX_STATE_confirm(PHYenum status)
{
    Ieee802154MacPhyPrimitives *primitive = new Ieee802154MacPhyPrimitives();
...
void IEEE802154_CT_PHY::PLME_SET_confirm(PHYenum status, PHYPIBenum attribute)
{
    Ieee802154MacPhyPrimitives *primitive = new Ieee802154MacPhyPrimitives();
...
void IEEE802154_CT_PHY::handle_PLME_SET_TRX_STATE_request(PHYenum setState)
{
    bool delay;
    PHYenum tmp_state;
...
void IEEE802154_CT_PHY::handle_PLME_SET_request(Ieee802154MacPhyPrimitives *primitive)
{
...
void IEEE802154_CT_PHY::changeChannel(int channel)
{
...
bool IEEE802154_CT_PHY::channelSupported(int channel)
{
    return ((def_phyChannelsSupported & (1 << channel)) != 0);
}

double IEEE802154_CT_PHY::getRate(char bitOrSymbol)
{
    double rate;
...
uint16_t IEEE802154_CT_PHY::calculateEnergyLevel()
{
    int energy;
...
void IEEE802154_CT_PHY::setRadioState(RadioState::State newState)
{
...
void IEEE802154_CT_PHY::addNewSnr()
{
...
void IEEE802154_CT_PHY::updateDisplayString() {
...
double IEEE802154_CT_PHY::calcDistFreeSpace()
{
...
void IEEE802154_CT_PHY::disconnectReceiver()
{
...
void IEEE802154_CT_PHY::connectReceiver()
{
